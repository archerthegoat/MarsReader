...
const SOURCES = [
  ...
  // Retained in the registry so historical entries can still resolve their source;
  // hidden sources are excluded from normal metadata, refreshes and lists.
  { id: 'theresanaiforthat', name: "There's An AI For That", category: 'article', siteUrl: 'https://newsletter.theresanaiforthat.com', enabled: false, hidden: true, limit: 5,
    feeds: ['https://newsletter.theresanaiforthat.com/feed'] },

  // ---------- Finance & Investing (BestBlogs WeChat2RSS) ----------
  { id: 'zeping-macro', name: '泽平宏观', category: 'article', siteUrl: 'https://www.zeping.cn', enabled: true, limit: 10,
    feeds: ['https://wechat2rss.bestblogs.dev/feed/4457d527901114d399a081ba4cf74688617a0ff4.xml'], description: '宏观与市场判断；RSS 由 BestBlogs WeChat2RSS 提供' },

  { id: 'barrons-china', name: "Barron's 巴伦", category: 'article', siteUrl: 'https://mp.weixin.qq.com', enabled: true, limit: 8,
    feeds: ['https://wechat2rss.bestblogs.dev/feed/707728196d05deab425a8dfa96f0084b6946f8cf.xml'], description: '全球市场与公司观察；RSS 由 BestBlogs WeChat2RSS 提供' },
  ...
  // Retained for historical entries, but no longer shown or accepted through
  // the personal-reader UI. The submission API remains available for
  // backwards compatibility with existing links and clients.
  { id: 'user-submitted', name: '读者提交', category: 'news', siteUrl: 'https://rss.qiaomu.ai', enabled: false, hidden: true, limit: 50,
    manual: true, feeds: [], description: '历史读者提交链接（已从个人阅读界面隐藏）' },
  { id: 'bestblogs', name: 'BestBlogs 精选', category: 'news', siteUrl: 'https://www.bestblogs.dev/articles', enabled: true, limit: 10,
    feeds: [
      'https://www.bestblogs.dev/zh/feeds/rss?featured=y&type=article&timeFilter=1d',
      'https://www.bestblogs.dev/feeds/rss?featured=y&type=article&timeFilter=1d',
    ], description: 'BestBlogs 中文精选文章（最近 1 天）' },
  ...
  { id: 'podcast-zhang-xiaojun', name: '张小珺 Jùn｜商业访谈录', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/626b46ea9cbbf0451cf5a962'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-guigu101', name: '硅谷 101', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/5e5c52c9418a84a04625e6cc'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-crossing', name: '十字路口 Crossing', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/60502e253c92d4f62c2a9577'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-ai-alchemy', name: 'AI 炼金术', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/63e9ef4de99bdef7d39944c8'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-tulong', name: '屠龙之术', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/6507bc165c88d2412626b401'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-bannatie', name: '半拿铁｜商业沉浮录', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/62382c1103bea1ebfffa1c00'], description: 'BestBlogs 选定播客；RSSHub 原 OPML 为 HTTP，本地验证 HTTPS 可用' },
  { id: 'podcast-whats-next', name: 'What’s Next｜科技早知道', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/5e74b52c418a84a046ecaceb'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-42jing', name: '42 章经', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/648b0b641c48983391a63f98'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-sanwuhuan', name: '三五环', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/5e280fab418a84a0461faa3c'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
  { id: 'podcast-wuren-zhidao', name: '无人知晓', category: 'podcast', siteUrl: 'https://www.xiaoyuzhoufm.com', enabled: true, limit: 10,
    feeds: ['https://rsshub.bestblogs.dev/xiaoyuzhou/podcast/611719d3cb0b82e1df0ad29e'], description: 'BestBlogs 选定播客；RSS 由 RSSHub 提供' },
